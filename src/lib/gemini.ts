...
if (!API_KEY) {
    console.warn("GEMINI_API_KEY is not defined in environment variables. Gemini features may not work.");
}

const genAI = new GoogleGenerativeAI(API_KEY || "");

console.log(`[Gemini Server] Initialized with key starting with: ${API_KEY?.substring(0, 5)}...`);
